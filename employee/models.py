...
class Employee(models.Model):
  official_email = models.ForeignKey('facerecognition.User', to_field='official_email',on_delete=models.CASCADE)
  personal_email = models.EmailField(('email address'), unique=True,blank=False)
